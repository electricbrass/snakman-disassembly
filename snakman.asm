...
_L1083  jsr     wait_for_start
        ldy     #$03
        sed
        sec
_L108A  lda     init_vram,y
        sbc     L1B7F+1,y
        dey
        bpl     _L108A
        cld
